...
export class Profile {
  ...
  public async info(
    ...
    return this.client.call<DefaultResult, IProfileResponse>({
      path: `/profile/${id}`,
      ...options,
    });
  }
  ...
  public async getBookmarks(
    data: IBookmarkRequest,
    options?: IBaseApiParams,
  ): Promise<IPageableResponse<IRelease>> {
    return this.client.call<DefaultResult, IPageableResponse<IRelease>>({
      path: `/profile/list/all/${data.id ? `${data.id}/` : ""}${data.type}/${data.page}`,
      queryParams: {
        sort: data.sort,
        filter: data.filter,
        filter_announce: data.filter_announce,
      },
      ...options,
    });
  }
  ...
  public async addBookmark(
    ...
    return this.client.call<DefaultResult, IResponse>({
      path: `/profile/list/add/${type}/${id}`,
      ...options,
    });
  }
  ...
  public async removeBookmark(
    ...
    return this.client.call<DefaultResult, IResponse>({
      path: `/profile/list/delete/${type}/${id}`,
      ...options,
    });
  }
  ...
  public async getFriends(
    ...
    options?: IBaseApiParams,
  ): Promise<IPageableResponse<IProfileShort>> {
    return await this.client.call<
      DefaultResult,
      IPageableResponse<IProfileShort>
    >({ path: `/profile/friend/all/${data.id}/${data.page}`, ...options });
  }
   ...
   */
  public async getFriendRecomendation(
    options?: IBaseApiParams,
  ): Promise<IPageableResponse<IProfileShort>> {
    return await this.client.call<
      DefaultResult,
      IPageableResponse<IProfileShort>
    >({ path: `/profile/friend/recomendations`, ...options });
  }
   ...
   */
  public async getLastFriendRequests(
    type: "in" | "out",
    count: number,
    options?: IBaseApiParams,
  ): Promise<IPageableResponse<IProfileShort>> {
  ...
  public async getFriendRequests(
    ...
    return await this.client.call<
      DefaultResult,
      IPageableResponse<IProfileShort>
    >({ path: `/profile/friend/requests/${type}/${page}`, ...options });
  }
  ...
  public async sendFriendRequest(
    id: number,
    options?: IBaseApiParams,
  ): Promise<IFriendRequestResponse> {
    return await this.client.call<
      SendFriendRequestResult,
      IFriendRequestResponse
    >({ path: `/profile/friend/request/send/${id}`, ...options });
  }
  ...
  public async removeFriendRequest(
    id: number,
    options?: IBaseApiParams,
  ): Promise<IFriendRequestResponse<RemoveFriendRequestResult>> {
    return await this.client.call<
      RemoveFriendRequestResult,
      IFriendRequestResponse<RemoveFriendRequestResult>
    >({ path: `/profile/friend/request/remove/${id}`, ...options });
  }
   ...
   */
  public async hideFriendRequest(
    id: number,
    options?: IBaseApiParams,
  ): Promise<IResponse> {
    return await this.client.call<DefaultResult, IResponse>({
   ...
   */
  public async getAchivement(
    id: string | number,
    options?: IBaseApiParams,
  ): Promise<IResponse<AchivementResult>> {
    return await this.client.call<
      AchivementResult,
      IResponse<AchivementResult>
    >({ path: `/achivement/get/${id}`, ...options });
  }
  ...
  public async getFavorites(
    data: Omit<IBookmarkRequest, "id" | "type">,
    options?: IBaseApiParams,
  ): Promise<IPageableResponse<IRelease>> {
    return await this.client.call<DefaultResult, IPageableResponse<IRelease>>({
      path: `/favorite/all/${data.page}`,
      queryParams: {
        sort: data.sort,
        filter: data.filter,
        filter_announce: data.filter_announce,
   ...
   */
  public async getSubsciptions(
    page: number,
    options?: IBaseApiParams,
  ): Promise<IPageableResponse<IChannel>> {
    return await this.client.call<DefaultResult, IPageableResponse<IChannel>>({
   ...
   */
  public async getSubscriptionCount(
    options?: IBaseApiParams,
  ): Promise<ISubsciptionCountResponse> {
    return await this.client.call<DefaultResult, ISubsciptionCountResponse>({
   ...
   */
  public async getVotedReleases(
    id: number,
    page: number,
    sort: number = 1,
    options?: IBaseApiParams,
  ): Promise<IPageableResponse<IVoteRelease>> {
    return await this.client.call<
      DefaultResult,
      IPageableResponse<IVoteRelease>
    >({
      path: `/profile/vote/release/voted/${id}/${page}`,
      queryParams: { sort },
      ...options,
    });
  }
  ...
  public async getSocials(
    id: number,
    options?: IBaseApiParams,
  ): Promise<ISocialResponse> {
    return await this.client.call<DefaultResult, ISocialResponse>({
   ...
   */
  public async getUnvotedReleases(
  ...
  public async exportBookmarks(
    listIds: Array<BookmarkType>,
    sort?: number,
    options?: IBaseApiParams,
  ): Promise<IExportBookmarksResponse> {
    return await this.client.call<
      BookmarkExportResult,
      IExportBookmarksResponse
    >({
      path: "/export/bookmarks",
      json: { bookmarksExportProfileLists: listIds },
      queryParams: { sort },
      ...options,
    });
  }
  ...
  public async getBlocklist(
    ...
    return await this.client.call<DefaultResult, IPageableResponse<IProfile>>({
   ...
   */
  public async removeFromBlocklist(
    id: number,
    options?: IBaseApiParams,
  ): Promise<IResponse<BlocklistAddResult>> {
    return await this.client.call<
      BlocklistAddResult,
      IResponse<BlocklistAddResult>
    >({ path: `/profile/blocklist/remove/${id}`, ...options });
  }
  ...
  public async getHealthStatus(
    options?: IBaseApiParams,
  ): Promise<IHealthStatusResponse> {
    return await this.client.call<DefaultResult, IHealthStatusResponse>({
  ...
  /**
   * Получение действий с контентом
   *
   * Возвращает список {@link IEditEnforcement<any>}, {@link IProfileEnforcement} и {@link IExpiringEnforcement} внутри {@link IPageableResponse}.
   *
   * Возможные ответы API в виде enum смотреть здесь {@link DefaultResult}
   *
   * @param page - Номер страницы
   ...
   *
   * @example
   * const result = await client.endpoints.profile.getEnforcementContent(0);
   */
  public async getEnforcementContent(
    page: number,
    options?: IBaseApiParams,
  ): Promise<
    IPageableResponse<
      IEditEnforcement<any> | IExpiringEnforcement | IProfileEnforcement
    >
  > {
    return await this.client.call<
      DefaultResult,
      IPageableResponse<
        IEditEnforcement<any> | IExpiringEnforcement | IProfileEnforcement
      >
    >({ path: `/profile/health/enforcement/content/all/${page}`, ...options });
  }

  /**
   * Получение ограничений аккаунта
   *
   * Возвращает список {@link IEditEnforcement<any>}, {@link IProfileEnforcement} и {@link IExpiringEnforcement}  внутри {@link IPageableResponse}.
   *
   * Возможные ответы API в виде enum смотреть здесь {@link DefaultResult}
   ...
   * @param page - Номер страницы
   * @param options - Дополнительные параметры
   * @returns Список ограничений
   *
   * @example
   * const result = await client.endpoints.profile.getEnforcementAccount(0);
   */
  public async getEnforcementAccount(
    page: number,
    options?: IBaseApiParams,
  ): Promise<
    IPageableResponse<
  ...
  > {
    return await this.client.call<
      ...
      IPageableResponse<
        IEditEnforcement<any> | IExpiringEnforcement | IProfileEnforcement
      >
    >({ path: `/profile/health/enforcement/account/all/${page}`, ...options });
  }
